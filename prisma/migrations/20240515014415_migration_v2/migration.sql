/*
  ...
  - You are about to drop the `packagings` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `type_packagings` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `users` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "rdq"."cities" DROP CONSTRAINT "cities_idDepartament_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."customers" DROP CONSTRAINT "customers_idCity_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."orders" DROP CONSTRAINT "orders_identification_user_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."orders" DROP CONSTRAINT "orders_iduser_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."packagings" DROP CONSTRAINT "packagings_idContent_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."packagings" DROP CONSTRAINT "packagings_idTypePackaging_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."product_orders" DROP CONSTRAINT "product_orders_idPackaging_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."product_orders" DROP CONSTRAINT "product_orders_order_number_fkey";

-- DropForeignKey
ALTER TABLE "rdq"."users" DROP CONSTRAINT "users_idRol_fkey";

-- DropTable
DROP TABLE "rdq"."cities";

-- DropTable
DROP TABLE "rdq"."contents";

-- DropTable
DROP TABLE "rdq"."customers";

-- DropTable
DROP TABLE "rdq"."departaments";

-- DropTable
DROP TABLE "rdq"."orders";

-- DropTable
DROP TABLE "rdq"."packagings";

-- DropTable
DROP TABLE "rdq"."product_orders";

-- DropTable
DROP TABLE "rdq"."roles";

-- DropTable
DROP TABLE "rdq"."type_packagings";

-- DropTable
DROP TABLE "rdq"."users";
