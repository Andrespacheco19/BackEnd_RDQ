...
*/
-- DropForeignKey
ALTER TABLE "public"."cities" DROP CONSTRAINT "cities_idDepartament_fkey";

-- DropForeignKey
ALTER TABLE "public"."customers" DROP CONSTRAINT "customers_idCity_fkey";

-- DropForeignKey
ALTER TABLE "public"."orders" DROP CONSTRAINT "orders_identification_user_fkey";

-- DropForeignKey
ALTER TABLE "public"."orders" DROP CONSTRAINT "orders_iduser_fkey";

-- DropForeignKey
ALTER TABLE "public"."packagings" DROP CONSTRAINT "packagings_idContent_fkey";

-- DropForeignKey
ALTER TABLE "public"."packagings" DROP CONSTRAINT "packagings_idTypePackaging_fkey";

-- DropForeignKey
ALTER TABLE "public"."product_orders" DROP CONSTRAINT "product_orders_idPackaging_fkey";

-- DropForeignKey
ALTER TABLE "public"."product_orders" DROP CONSTRAINT "product_orders_order_number_fkey";

-- DropForeignKey
ALTER TABLE "public"."users" DROP CONSTRAINT "users_idRol_fkey";
...
-- DropTable
DROP TABLE "public"."type_packagings";
